...
// @ts-ignore
export async function resolve(request, serverState, routes) {
    console.log("~resolve~")
...
// @ts-ignore
export async function serveFromRouter(serverState, routes, request, response, fallbackCallback) {
...
// @ts-ignore
export function waitForChanges(serverState, time) {
