...
function renderTalk(talk, dispatch) {
    ...
    }, "Delete")), elt("div", null, "by ", elt("strong", null, talk.presenter)), elt("p", null, talk.summary), ...talk.comments.map(renderComment), elt("form", {
        // @ts-ignore
        onsubmit(event) {
...
var SkillShareApp = class SkillShareApp {
    ...
    constructor(state, dispatch) {
        ...
        // @ts-ignore
        this.talkDOM, renderTalkForm(dispatch));
...
runApp();
//# sourceMappingURL=skillsharing_client.js.map